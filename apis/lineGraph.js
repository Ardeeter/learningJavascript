$(async() => {
    ...
    console.log(recommendation3);
        ...
        var $canvasBar1 = $('<canvas id="myBarChart1" class="col-4">');
        var $canvasPie1 = $('<canvas id="myPieChart1" class="col-4">');
        var $canvasLine1 = $('<canvas id="myLineChart1" class="col-4">')
    ...
    // Line Graph for Income for Recommendation 1
